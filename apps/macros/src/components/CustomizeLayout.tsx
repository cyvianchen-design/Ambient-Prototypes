...
export function CustomizeLayout({ children }: Props) {
    ...
    <div className="flex h-screen overflow-hidden bg-white font-['Lato',sans-serif]">
      ...
      <div className="w-[220px] shrink-0 h-full flex flex-col bg-white border-r border-[var(--shape-outline)]">
        ...
        <div className="h-[48px] shrink-0 flex items-center px-[16px]">
          <span
            className="t-title-md text-[var(--foreground-primary)]"
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="px-[12px] h-[30px] flex items-center">
            <span className="t-title-xs text-[var(--foreground-secondary)]">
              Global Settings
            </span>
          </div>
            ...
            return (
              ...
              >
                <div className="flex-1 min-w-0 flex items-center gap-[6px] overflow-hidden">
                  <span
                    className="shrink-0 t-title-sm text-[var(--foreground-primary)]"
                    style={{ fontFeatureSettings: "'ss07'" }}
                  >
                    {item.label}
                  </span>
                  {item.isDefault && (
                    <span className="t-body-sm text-[var(--foreground-primary)] truncate">
                      (default)
                    </span>
                  )}
                </div>
