...
import { Badge, Button, TextArea } from "@ds/ui";
import { CustomizeLayout } from "../components/CustomizeLayout";
import { SectionCard } from "../components/SectionCard";
import { useMacroDrawer } from "../macroContext";
...
export default function R2Baseline() {
  ...
  useEffect(() => {
    setOpenMacro({ macro: subjectiveMacros[0], sectionTitle: "Subjective" });
  }, []);
  return (
    <CustomizeLayout>
        ...
        <div className="flex flex-col items-center gap-[24px] px-[20px] py-[24px]">
          ...
          <div className="w-full max-w-[600px] flex flex-col gap-[16px] shrink-0 pb-[8px]">
            <div className="flex items-center justify-between">
              ...
              <Badge label="Apply to all sections" variant="default" filled />
            </div>
      ...
      <div className="shrink-0 bg-white px-[20px] py-[16px] flex justify-center">
