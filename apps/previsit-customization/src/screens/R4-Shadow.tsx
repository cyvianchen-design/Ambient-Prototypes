...
import { Icon, IconButton, Button, Checkbox, Tabs, Overlay, MagicEdit, Menu, MenuItem, Snackbar, Chip, Link, Citation } from "@ds/ui";
          ...
          <>
            ...
            <div className="fixed right-0 top-0 h-full w-full md:w-[640px] z-[160] bg-white shadow-[-4px_0_24px_rgba(0,0,0,0.1)] flex flex-col">
              ...
              {sectionGhost && (
                ...
                >
                  <div className="bg-white border border-[var(--shape-outline,rgba(0,0,0,0.1))] rounded-[6px] p-[4px] flex items-center gap-[8px] h-[36px] px-[4px] [box-shadow:var(--shadow-s)]">
              ...
              {subGhost && (
                ...
                >
                  <div className="bg-white border border-[var(--shape-outline,rgba(0,0,0,0.1))] rounded-[6px] p-[4px] flex items-center gap-[8px] h-[28px] px-[4px] [box-shadow:var(--shadow-s)]">
                    <div className="shrink-0 leading-[0] text-[var(--foreground-secondary,#666)]">
                      <Icon name="drag_indicator" size={16} />
                    </div>
