                  ...
                  <div className="group flex items-start gap-[4px]">
                    ...
                    >
                      <div className="flex items-center gap-[8px]">
                        <span className="shrink-0 w-[64px] text-[13px] font-bold leading-[1.2] tracking-[0.13px] text-[var(--foreground-brand,#1132ee)]" style={{ fontFeatureSettings: "'ss07'" }}>
                          {c.code}
                        </span>
                      ...
                      {c.providerLabel && (
                        <span className="text-[13px] font-normal leading-[1.2] tracking-[0.13px] text-[var(--foreground-secondary,#666)] ml-[72px]">
                          {c.description}
                        </span>
                      )}
                    </div>
