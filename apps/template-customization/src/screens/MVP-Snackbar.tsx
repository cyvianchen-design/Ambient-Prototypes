...
import { Button, Checkbox, Chip, EditableTitle, SelectChip, Icon, IconButton, Menu, MenuHeader, MenuItem, MenuSearch, Snackbar, SpotMenuItem, Switch, Table, TextArea } from "@ds/ui";
...
function PreviewSidebar({ sections, width, needsRefresh, onRefresh, onDismissRefresh, onSourceChange, onResizeStart }: {
      ...
      {needsRefresh && (
        <div className="shrink-0 px-[24px] pb-[12px]">
          <Snackbar
            ...
            action={{ label: "Refresh", prefix: <Icon name="refresh" size={16} />, onClick: onRefresh }}
  ...
  return (
    <div className="flex h-full overflow-hidden">
      ...
      <PreviewSidebar
        ...
        onDismissRefresh={() => setPreviewNeedsRefresh(false)}
...
export default function MVPSnackbar() {
