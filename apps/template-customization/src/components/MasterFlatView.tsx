...
export function MasterFlatView({ mode }: { mode: Mode }) {
  ...
  return (
    <div className="flex h-full overflow-hidden">
      ...
      {/* Preview — sidebar, content directly on white (like the assistant panel) */}
      <div className="w-[440px] shrink-0 h-full bg-white border-l border-[var(--shape-outline,rgba(0,0,0,0.1))] flex flex-col">
