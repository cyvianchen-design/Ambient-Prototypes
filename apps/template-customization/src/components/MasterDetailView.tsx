...
function SubsectionCard({
  ...
  return (
    <div ref={registerRef} data-subid={sub.id} className="scroll-mt-[16px] border border-[rgba(0,0,0,0.1)] rounded-[10px] p-[16px] flex flex-col gap-[16px]">
      {/* Header */}
...
export function MasterDetailView({ mode }: { mode: Mode }) {
  ...
  return (
    <div className="flex h-full overflow-hidden">
      {/* Outline / jump nav */}
      <div className="w-[280px] shrink-0 h-full border-r border-[var(--shape-outline,rgba(0,0,0,0.1))] flex flex-col">
        <div className="shrink-0 h-[56px] flex items-center px-[16px] border-b border-[var(--shape-outline,rgba(0,0,0,0.1))]">
