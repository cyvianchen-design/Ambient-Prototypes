...
// Matches the recording prototype's "Recording Background": a #4c5ce6 base with
// three radial-gradient lobes on a 1441×833 reference canvas, scaled to fill.
export function GradientBackground({ className = "" }: { className?: string }) {
  return (
    ...
    >
      <defs>
        <radialGradient id="rec-grad-pink" gradientUnits="userSpaceOnUse" cx="0" cy="0" r="10" gradientTransform="matrix(33.703 -33.05 39.391 36.894 590.59 734)">
        ...
        <radialGradient id="rec-grad-blue" gradientUnits="userSpaceOnUse" cx="0" cy="0" r="10" gradientTransform="matrix(54.364 30.75 -33.695 54.713 897.36 417)">
        ...
        <radialGradient id="rec-grad-purple" gradientUnits="userSpaceOnUse" cx="0" cy="0" r="10" gradientTransform="matrix(34.59 57.4 -65.955 36.505 548.85 222)">
